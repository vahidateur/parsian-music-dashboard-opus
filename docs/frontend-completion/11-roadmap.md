...
- **Risks:** Teacher sees all students org-wide currently — assigned scope decision T-02 needed not silently assumed — document current ALLOWED org-wide + desired DENIED assigned; Compensation client-side permission server must re-derive D19; Media resolution != auth D15
