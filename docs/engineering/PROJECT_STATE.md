...
- A **documentation checkpoint** is a pushed commit that changes documents and validation gates
  but no product behaviour. **Twenty-three** are **named** so far — the twenty-fourth is the commit carrying
