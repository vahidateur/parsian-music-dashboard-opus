...
- **The surface (2026-09-16, later than P1).** `fc83d6d` added `src/views/Compensation.tsx`, its three
  ...
  tenth — per-surface gate coverage — open as [OPEN_ITEMS.md](OPEN_ITEMS.md) I21**. Evidence:
