...
| Product-feature phase | — | — | M3, M4, M5, M6, M7, M8, M9 and M10 ✅ **COMPLETE** (rows above); remaining milestone M11 ❌ **NOT STARTED** |
...
## Product-feature phase — SPECIFIED (M0); M1, M2, M2.1, M3, M4, M5, M6, M7, M8, M9 and M10 LANDED; M11 NOT STARTED
...
M11 ❌ **not started, not authorized** — its decision gate (**D7/D8/D9**) is recorded (2026-09-16, documents only; see the table row and "Documentation checkpoints"), pending a separate implementation authorization.
...
| M11 — performance, api disclosure, a11y, browser QA | **I6**, **D7**, **D8**, **D9**, **L4** | ❌ **not started — not authorized**; its three decision dependencies (**D7**, **D8**, **D9**) are discharged by the owner's **decision-record pass of 2026-09-16** — D9 carrying its measured baseline and budget shape ([DECISIONS.md](DECISIONS.md) §19 → D7/D8/D9), and L4's browser-QA environment disposition recorded in [PROJECT_STATE.md](PROJECT_STATE.md) §5 — **none of which authorizes implementation**; a separate owner authorization is still required |
...
**it does not authorize M11** — the milestone row above keeps saying
